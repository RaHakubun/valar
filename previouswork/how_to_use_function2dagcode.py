...
if __name__ == "__main__":
    # 指定 YAML 文件路径
    yaml_file_path = "nodes_example.yaml"
    ...
    try:
        ...
        print("="*50)
        # 生成函数调用
        result = generate_function_calls(text_to_image_workflow, yaml_data).strip()
        print(result)
        print("\n")
        
        print("示例2: 带ControlNet的图像到图像工作流")
        print("="*50)
        # 生成函数调用
        result = generate_function_calls(image_to_image_workflow, yaml_data).strip()
        print(result)
        print("\n")
